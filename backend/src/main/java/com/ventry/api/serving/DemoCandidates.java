 ...
 * 좌표 WGS84, 금액 만원 단위. 가정: docs/assumptions.md.
 */
@Component
public class DemoCandidates {
    ...
    private static final CandidateArea MANGWON = new CandidateArea(
            ...
            new AxisScores(0.82, 0.74, 0.68, 0.71, 0.77), 0.11,
    ...
    private static final CandidateArea HAPJEONG = new CandidateArea(
            ...
            new AxisScores(0.79, 0.81, 0.55, 0.66, 0.70), 0.13,
    ...
    private static final CandidateArea HONGDAE = new CandidateArea(
            ...
            new CostBlocks(new Interval(4000, 4600), new Interval(1300, 1600),
                    new Interval(1000, 1300), 100),          // incl 중앙값 7,500 ≤ 8,000, 부담률 0.19 > θ → 유의
            new AxisScores(0.91, 0.88, 0.31, 0.74, 0.52), 0.19,
    ...
    private static final CandidateArea YEONNAM = new CandidateArea(
            ...
            new AxisScores(0.75, 0.70, 0.60, 0.62, 0.66), 0.16,
