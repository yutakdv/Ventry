...
public final class MockData {
    ...
    public static PlanEvent explorePlan() {
        List<String> axes = List.of("A1", "A4");
        return new PlanEvent(axes, ExploreAxis.labels(axes), "대화 맥락 기반: 권리금 축 우선 검토");
    }
    ...
    public static InsightEvent insightT1() {
        return new InsightEvent("i-1", "T1",
                ...
                new Funding("서울신용보증재단 창업보증", 1500, 2.5, 60, "open", "2026-05-15",
                        "SGF_STARTUP",
                        new Source("서울신용보증재단", "https://www.seoulshinbo.co.kr", "2026-07-19"),
                        null),
                true);
    ...
    public static DoneEvent exploreDone(int currentBudget) {
        return new DoneEvent(6,
                List.of(List.of(6480, 3), List.of(7800, 5), List.of(9320, 11)), currentBudget);
    }
}
